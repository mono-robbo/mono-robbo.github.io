...
(function (root) {
  function buildCheckoutUrl(base, context) {
    ...
    const patterns = {
      ...
      utm_campaign: /^2026q3_pool_99$/, utm_content: /^(control|challenger)$/,
    ...
    target.searchParams.set('client_reference_id', ['pool99', safe.outreach_batch_id || 'unattributed', safe.outreach_variant || safe.utm_content || 'unknown'].join('_'));
    return target.href;
  }
